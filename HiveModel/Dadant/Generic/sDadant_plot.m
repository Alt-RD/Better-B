...
lPlotNodesInfos = struct( 'nodeName', { 'nAirExt', ...
                                        'nHBBot', ...
                                        lVolumes.hiveBody(1).nodes{:}, ...
                                        lVolumes.hiveBody(2).nodes{:}
                                        }, ...
                          'displayName', {'Air ext.', ...
                                          'Hive body bottom', ...
                                          lVolumes.hiveBody(1).nodes{:}, ...
                          ...
                          'lineStyle', {'-', ...
                                        '-', ...
                                        repmat({'--'}, 1, numel(lVolumes.hiveBody(1).nodes)){:}, ...
                                        repmat({'--'}, 1, numel(lVolumes.hiveBody(2).nodes)){:}}, ...
                          'lineColor', {'black', ...
                                        'red', ...
                                        repmat({'blue'}, 1, numel(lVolumes.hiveBody(2).nodes)){:}, ...
                                        repmat({'blue'}, 1, numel(lVolumes.hiveBody(2).nodes)){:}}, ...
                          'lineWidth', 4);

lPlotVolumeInfos = struct('volumes', { lVolumes.hiveBody }, ...
...
lPlotFacesList = { HT_Face_Find(lFaces.sideWall1{1}, 'orientation', lHiveParams.globalAxis(:,X), 'numberCheck', 1, 'returnType', true), ...
                   HT_Face_Find(lFaces.sideWall2{1}, 'orientation', -lHiveParams.globalAxis(:,X), 'numberCheck', 1, 'returnType', true) };
...
for i=1:6
  h = plot(t/3600,  lCmdInfos.hiveBodyIrradiance(:,i),              ...
                    'linewidth', 3.0,                 ...
                    'color', lPlotColors.faces(i,:),  ...
                    'displayname', sprintf('Sidewalls %s', lFaceName{i}));
endfor
for i=1:6
  h = plot(t/3600,  lCmdInfos.roofIrradiance(:,i),              ...
                    'linewidth', 3.0,                 ...
                    'color', lPlotColors.faces(i,:),  ...
                    'linestyle', ':', ...
