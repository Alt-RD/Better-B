...
lSensitivityParams = struct(...
  'multEpsilon', 0.02, ...
  'parameterFile', 'sDadant_setupParamsSensitivity.m', ...
  'cacheFile', 'Dadant_SensitivityBackup.mat', ...
  'dependencies', {{'sDadant.setupParams.m'}}); % Specify the file whose changes will remove cache file
